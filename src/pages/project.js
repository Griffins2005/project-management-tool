...
const Project = () => {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get("https://project-management-backend-vrup.onrender.com/api/projects");
  ...
  const createProject = async () => {
    ...
    try {
      const response = await axios.post("https://project-management-backend-vrup.onrender.com/api/projects", { name: newProjectName });
  ...
  const updateProject = async (id, newName) => {
    try {
      await axios.put(`https://project-management-backend-vrup.onrender.com/api/projects/${id}`, { name: newName });
  ...
  const deleteProject = async (id) => {
    ...
    try {
      await axios.delete(`https://project-management-backend-vrup.onrender.com/api/projects/${id}`);
      await axios.delete(`https://project-management-backend-vrup.onrender.com/api/tasks?projectId=${id}`);
