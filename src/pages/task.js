...
const Task = ({
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      const response = await axios.get(`https://project-management-backend-tool.onrender.com/api/tasks/${projectId}`);
  ...
  const handleAddTask = async () => {
    ...
    try {
      ...
      const response = await axios.post(`https://project-management-backend-tool.onrender.com/api/tasks/${projectId}`, taskWithProjectIdAndPriority);
  ...
  const handleEditTask = (taskId, field, value) => {
    ...
    const taskToUpdate = updatedTasks.find((task) => task._id === taskId);
    axios
      .put(`https://project-management-backend-tool.onrender.com/api/tasks/${projectId}/${taskId}`, taskToUpdate)
  ...
  const handleStatusChange = (taskId, newStatus) => {
    ...
    setTasks(updatedTasks);
    axios
      .put(`https://project-management-backend-tool.onrender.com/api/tasks/${projectId}/${taskId}`, { status: newStatus })
  ...
  const handleAssigneeChange = (taskId, newAssignee) => {
    ...
    setTasks(updatedTasks);
    axios
      .put(`https://project-management-backend-tool.onrender.com/api/tasks/${projectId}/${taskId}`, { assignedTo: newAssignee })
